...
@php
    $path = url("/Modules/PabblyConnect/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Build Powerful ')}}<b>{{__('Automations')}}</b>{{__(' with No Code.')}}</h2>
                <p>{{__('Easy-to-use built-in tools that help you create workflows with advanced capabilities like scheduling, delay, router, and many more.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Pabbly Connect integrates 1000+ apps, enabling instant data transfer.')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Schedule Workflows')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Set up a date and time at which you want the workflow to be executed. Like on a specific day, once in a day, and every min/hour/day/week.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Advance Workflows')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Create advanced workflows with the help of routers/paths. With the help of a router, you will be able to execute different actions based on the filter conditions you set.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Delay Workflows')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Delay step allows you to delay performing the next action for a specified amount of period. The period can be either mins/hours/days/weeks or any specific date and time.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Automate for enhanced workflow Efficiency.')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Connect Any Application')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Integrate to any application with an API using API modules. This module offers custom options and supports many different API structures.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Email Parser')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Email Parser automatically extracts data from the incoming emails like email name, subject, the body of the email, attachments, etc. which can be processed further.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Iterator')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Iterator divides a collection of data into numerous values, which are then processed one by one until the last value is reached. Each value can be passed to other action steps added after the Iterator step.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Imagine The Possibilities of Automating Anything!')}}</h2>
                        </div>

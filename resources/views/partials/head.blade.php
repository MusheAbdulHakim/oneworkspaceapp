@php
    $favicon = isset($admin_settings['favicon'])
...
<head>
    ...
    <title>@yield('page-title') |
        {{ !empty($admin_settings['title_text']) ? $admin_settings['title_text'] : (!empty($admin_settings['title_text']) ? $admin_settings['title_text'] : 'WorkDo') }}
    </title>
    ...
    @endif
    @if (
        (isset($admin_settings['site_rtl']) ? $admin_settings['site_rtl'] : 'off') != 'on' &&
            (isset($admin_settings['cust_darklayout']) ? $admin_settings['cust_darklayout'] : 'off') != 'on')
